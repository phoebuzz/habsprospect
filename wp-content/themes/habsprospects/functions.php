...
function sparkling_setup() {
  ...
  add_image_size( 'fullwidth-slider', 9999, 600, true); // Small Thumbnail
...
/* ------------------- Custom Post Type: Prospects */

add_action('init', 'create_cpt_prospects', 0);
function create_cpt_prospects() {
    $labels = array(
        'name'                => _x('Prospects', 'Post Type General Name', 'text_domain'),
        'singular_name'       => _x('Propriété', 'Post Type Singular Name', 'text_domain'),
        'menu_name'           => __('Prospects', 'text_domain'),
        'parent_item_colon'   => __('Prospect parent:', 'text_domain'),
        'all_items'           => __('All Prospects', 'text_domain'),
        'view_item'           => __('See prospect', 'text_domain'),
        'add_new_item'        => __('Add a prospect', 'text_domain'),
        'add_new'             => __('New prospect', 'text_domain'),
        'edit_item'           => __('Edit prospect', 'text_domain'),
        'update_item'         => __('Update prospect', 'text_domain'),
        'search_items'        => __('Search a prospect', 'text_domain'),
        'not_found'           => __('No prospect found', 'text_domain'),
        'not_found_in_trash'  => __('No prospect found in trash', 'text_domain'),
    );
    $args = array(
        'label'               => __('Prospects', 'text_domain'),
        'description'         => __('Prospects', 'text_domain'),
        'labels'              => $labels,
        'hierarchical'        => true,
        'can_export'          => true,
        'has_archive'         => true,
    ...
    /* ------------------- Taxonomy: Prospect Ligue */

    add_action('init', 'create_prospects_villes_types_tanonomy', 0);
    function create_prospects_villes_types_tanonomy() {
        $labels = array(
            'name'                  => _x('Ligue', 'taxonomy general name'),
            'singular_name'         => _x('Ligue', 'taxonomy singular name'),
            'search_items'          => __('Find a ligue'),
            'all_items'             => __('All ligues'),
            'parent_item'           => __('Ligue parent'),
            'parent_item_colon'     => __('Ligue parent:'),
            'edit_item'             => __('Edit Ligue'),
            'update_item'           => __('Update ligue'),
            'add_new_item'          => __('Add new ligue'),
            'new_item_name'         => __('New ligue'),
            'menu_name'             => __('Ligue')
        );

        $custom_post_types = array('prospects');
        ...
        register_taxonomy('ligue', $custom_post_types, $args);
    }
