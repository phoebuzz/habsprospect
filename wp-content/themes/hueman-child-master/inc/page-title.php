<div class="page-title pad group">
	...
	<?php elseif ( is_singular( 'players' ) ) : ?>

		<ul class="meta-single group">
			<li class="category"><span><?php _e('Player Profile','habsprospect'); ?></span></li>
			<?php the_title(); ?>
	...
	<?php elseif ( is_author() ): ?>
		...
		<h1><i class="fa fa-user"></i><?php _e('Author:','hueman'); ?> <?php _e('Player Search','habsprospect'); ?><span><?php echo $author->display_name;?></span></h1>
	...
	<?php elseif ( is_tax('leagues') ): ?>
		<h2>League : <?php echo get_query_var('leagues'); ?></h2>

	<?php elseif ( is_archive('players') ): ?>
		<h2>Prospects</h2>
	<?php else: ?>	
		<h2><?php the_title(); ?></h2>
